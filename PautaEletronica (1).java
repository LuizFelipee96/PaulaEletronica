...
public class PautaEletronica {
	...
	private void exibirMenu() {
		System.out.println("Menu: \n\n" + "1. Inserir aluno\r\n" + "2. Pesquisar aluno por nome\r\n"
				+ "3. Inserir notas\r\n" + "4. Excluir aluno\r\n"
				+ "5. Relatório de alunos\r\n 	Nome | Nota 1 | Nota 2 | Nota 3 | Média | Situação\r\n"
	...
	private void inserirAluno() {
		...
		System.out.println("Você deseja inserir a nota deste aluno?\n1- Sim\n2- Não");
		int option = getInt("");
		if (option == 1) {
			Double nota1, nota2, nota3;
			System.out.println("Digite a primeira nota do(a) aluno(a): ");
			nota1 = getNota("");
			System.out.println("Você quer digitar outra nota?\n1- Sim\n2- Não");
			option = getInt("");
			if (option == 1) {
	...
	private String pegarNome() {
		System.out.print("Digite o nome do(a) aluno(a) que você deseja encontrar: ");
	...
	private boolean verificarAlteracaoDeNota() {
		int option;
		System.out.println("Essa nota já foi preenchida. Tem certeza que deseja alterar?\n1- Sim\n2- Não");
		option = getInt("Essa nota já foi preenchida. Tem certeza que deseja alterar?\n1- Sim\n2- Não");
		return option != 1;
	}
	...
	private void inserirNotas() {
		...
		do {
			System.out.println(
					"Digite a nota que irá ser alterada.\n1- Primeira Nota\n2- Segunda Nota\n3- Terceira Nota");
			option = getInt("Digite a nota que irá ser alterada.\n1- Primeira Nota\n2- Segunda Nota\n3- Terceira Nota");
			switch (option) {
			...
			System.out.println("Você deseja preencher mais uma nota? \n1- Sim\n2- Não");
			option = getInt("Você deseja preencher mais uma nota? \n1- Sim\n2- Não");
		} while (option == 1);
	}
